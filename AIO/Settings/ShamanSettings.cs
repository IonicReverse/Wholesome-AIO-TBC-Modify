...
namespace WholesomeTBCAIO.Settings
{
    ...
    public class ShamanSettings : BasePersistentSettings<ShamanSettings>
    {
        public ShamanSettings()
        {
            ...
            PartyStandBehind = false;
            PartyRipTideThreshold = 90; 
        ...
        [Category("Party")]
        [DefaultValue(90)]
        [DisplayName("[RES] RipTide")]
        [Description("Use RipTide when ally has less HP than this threshold")]
        [Percentage(true)]
        public int PartyRipTideThreshold { get; set; }
